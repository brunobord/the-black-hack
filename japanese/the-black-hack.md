...
鎧や盾は与えられたダメージの値を減少させる防護となり、種類毎にダメージを引き受けられる限界、**装甲値**を持つ。装甲値はキャラクターが休息することで回復する。いったんプレイヤーまたはモンスターが防護で装甲値を使い切ると、彼らはあまりに疲れるか傷つくかして、その鎧や盾を有効活用できない――その時点からはダメージの値をそのまま受けることになる。
...
「装備品」の表に列記されている品で、**用量ダイス**が割り当てられている物はすべて消耗品、使用回数が限定される品と見なされる。その品を次の**ミニッツ**（ターン）に使用する場合、用量ダイスを振る。もし出目が１か２なら、その用量ダイス以下に示した列に照らして１段階、面数の少ないダイスへと格下げされる。
...
能力値の増加を確認する際に、**ＤＥＸ**と**ＷＩＳ**については２回ダイスを振る。
...
能力値の増加を確認する際に、**ＳＴＲ**と**ＷＩＳ**については２回ダイスを振る。
...
能力値の増加を確認する際に、**ＩＮＴ**と**ＷＩＳ**については２回ダイスを振る。
